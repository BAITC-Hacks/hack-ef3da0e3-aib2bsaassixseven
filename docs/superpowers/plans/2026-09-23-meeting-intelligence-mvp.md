...
### Задача 1. Зафиксировать единый контракт данных
...
### Задача 2. Проверить модели на реальном аудио
...
### Задача 3. Локальные модели и надёжное хранилище
...
### Задача 4. NVIDIA inference API и один worker
...
### Задача 5. Публичная загрузка и чтение встреч
...
### Задача 6. Coordinator: передача, результат и восстановление
...
### Задача 7. Очистка, retry и удаление
...
### Задача 8. Review, approval и PDF на backend
...
### Задача 9. Загрузка, список и прогресс на frontend
...
### Задача 10. Экран проверки и экспорт на frontend
...
### Задача 11. Сквозная приёмка и честное демо
